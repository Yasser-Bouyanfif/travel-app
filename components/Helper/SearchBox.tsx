    ...
    return (
        <div className="flex flex-col items-center w-full mb-15">
            <form onSubmit={handleSearch} className="w-full max-w-6xl" action="">
                <div
                    className="bg-white rounded-lg p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center justify-center gap-8 mt-4 sm:mt-12 mx-auto">
                    <div className="flex items-center space-x-6">
                        <FaHotel className="w-6 h-6 text-gray-600"/>
                        <div>
                            <p className="text-lg font-medium mb-2">Location</p>
                            <select onChange={handleChange} value={formData.location} name="location">
