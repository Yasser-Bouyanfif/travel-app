    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-30 px-10">
            <div className="max-w-4xl mx-auto mb-12">
                ...
                <div
                    className="max-w-4xl bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100 mx-auto mb-12">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="rating" className="block text-gray-700">Your Rating</label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="comment" className="block text-gray-700">Your Review</label>
                            <textarea
                                onChange={handleChange}
                                id="comment"
                                className={`w-full p-2 sm:p-3 mt-1 border border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500 ${redInputs.name ? "border-red-500" : ""}`}
                ...
                {[...Array(totalPages)].map((_, i) => (
                    <button
                        ...
                        className={`px-4 py-2 border cursor-pointer ${
                            currentPage === i + 1 ? "bg-gray-700 text-white" : "bg-white text-gray-700"
                        } rounded`}
                    >
                        {i + 1}
                    </button>
