    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const hotelData = data.filter((stay: { hotel: Hotel }) => stay.hotel.name === name)
                setHotel(hotelData)
            ...
            {hotel.map((obj, index) => (
                <div
                    ...
                    <div className="p-6 space-y-4">
                        <h2 className="text-2xl font-bold text-gray-800">{obj.hotel.name}</h2>
                    ...
                    <div className="border-t px-6 py-4 flex justify-between items-center">
                        <div>
                            <ul className="mt-3 mb-3 font-semibold text-gray-700">
                                <li>Arrival: <span
                                    className="text-red-700 font-bold">{startFormatted}</span></li>
                                <li>Departure: <span className="text-red-700 font-bold">{endFormatted}</span></li>
                                <li>Number of guests: <span className="text-red-700 font-bold">1</span></li>
                            </ul>
                    ...
                    <div
                        className="border-t px-6 py-4 bg-gray-50 flex flex-col md:flex-row justify-between items-center">
