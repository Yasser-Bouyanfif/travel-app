            ...
            <div className="max-w-2xl w-full bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div className="bg-white p-6 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-800">Your Booking is Confirmed</h1>
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        <div className="flex">
                            ...
                            <div className="p-4 flex-1">
                                <h2 className="text-xl font-bold text-gray-800">{hotelData.name}</h2>
                                <div className="flex items-center mt-1">
                                    <div className="flex text-amber-400 mr-2">
                                        {"⭐".repeat(Math.round(hotelData.rating))}{" "}
                                    </div>
                                    <span className="text-sm text-gray-600">{hotelData.location}</span>
                                </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between">
                                <span
                                    className="text-gray-600">{roomData.price_per_night} $ × {Math.ceil((new Date(endDate) - new Date(startDate)) / (1000 * 60 * 60 * 24))} night(s)</span>
                                <span>{total} $</span>
                            </div>
                            <div className="flex justify-between">
                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                    <Link href="/orders">
                        <button
                            className="flex w-full bg-blue-600 justify-center text-white py-2 px-4 rounded hover:bg-blue-700 transition cursor-pointer">
                            View Details
                        </button>
                    </Link>
                    <p className="text-center text-sm text-gray-500 mt-4">
                        Questions? Contact us at <span className="text-blue-600">+1 234 567 89</span>
                    </p>
                </div>
            </div>
        </div>
